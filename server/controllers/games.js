...
const getGamesData = async (req, res) => {
	...
	try {
		const data = "fields name, cover.*, websites.*, genres.*; where rating >= 60 & release_dates.date > 1577231999 & cover != null & rating != null & artworks != null & websites != null; sort rating desc; limit 100;"
